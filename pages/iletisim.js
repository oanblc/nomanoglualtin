          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex items-center justify-between h-20">
              ...
              <nav className="hidden md:flex items-center space-x-1">
                ...
                <Link href="/iletisim" className="px-4 py-2 text-base font-normal text-gray-900 bg-white/30 rounded-lg">
                  İletişim
                </Link>
              </nav>
            ...
            {mobileMenuOpen && (
              <div className="md:hidden py-4 border-t border-white/30">
                <nav className="flex flex-col space-y-1">
                  <Link href="/" className="px-4 py-3 text-base font-normal text-gray-800 hover:bg-white/20 rounded-lg">
                    Fiyatlar
                  </Link>
                  <Link href="/piyasalar" className="px-4 py-3 text-base font-normal text-gray-800 hover:bg-white/20 rounded-lg">
                    Piyasalar
                  </Link>
                  <Link href="/iletisim" className="px-4 py-3 text-base font-normal text-gray-900 bg-white/30 rounded-lg">
                    İletişim
                  </Link>
                </nav>
              </div>
