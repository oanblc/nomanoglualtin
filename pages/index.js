            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <div className="flex flex-col space-y-2">
                  <a href="https://apps.apple.com/tr/app/nomano%C4%9Flu-alt%C4%B1n/id6759252271?l=tr" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-2 px-3 py-2 bg-gray-900 hover:bg-gray-800 rounded-lg transition-colors">
